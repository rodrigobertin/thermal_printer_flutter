...
#include "include/thermal_printer_flutter/thermal_printer_flutter_plugin.h"
#include "thermal_printer_flutter_plugin_private.h"
...
TEST(ThermalPrinterFlutterPlugin, GetPlatformVersion) {
